...
static int __attribute__((used)) scePadReadState_Hook(int handle, OrbisPadData *pData, BO6ExtraStuff *restrict stuff){

    volatile unsigned long long Hello_BO6[2];
    Hello_BO6[0] = 0x7266206f6c6c6548;
    Hello_BO6[1] = 0x0000364f42206d6f;
    ...
    if (is_connected && !stuff->loaded)
    {
        ...
        (void)res;
        stuff->sceKernelDebugOutText(0, (const char*)Hello_BO6);
        stuff->loaded = 1;
    }
